...
ActiveRecord::Schema.define(version: 20161027182556) do
  ...
  create_table "visits", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dog_id"], name: "index_visits_on_dog_id", using: :btree
    t.index ["dogpark_id"], name: "index_visits_on_dogpark_id", using: :btree
    t.index ["owner_id"], name: "index_visits_on_owner_id", using: :btree
  end

  add_foreign_key "dogs", "owners"
  add_foreign_key "visits", "dogparks"
